...
downloads:
  Vapecord.Public.zip:
    size: 4466201
    size_str: 4 MiB
    url: https://github.com/RedShyGuy/Vapecord-ACNL-Plugin/releases/download/v3.2.1/Vapecord.Public.zip
...
update_notes: '<h1 dir="auto">First hotfix!</h1>
  ...
  <li>Chat Translation Options having too long text and getting cut off</li>
...
updated: '2026-03-14T08:39:11Z'
version: v3.2.1
version_title: ACNL Vapecord Public Plugin [v.3.2.1]
